 ...
 */
public enum YeeLeiMallOrderStatusEnum {
    ...
    YeeLeiMallOrderStatusEnum(int orderStatus, String name) {
        this.orderStatus = orderStatus;
        this.name = name;
    }

    public static YeeLeiMallOrderStatusEnum getYeeLeiMallOrderStatusEnumByStatus(int orderStatus) {
        for (YeeLeiMallOrderStatusEnum newBeeMallOrderStatusEnum : values()) {
