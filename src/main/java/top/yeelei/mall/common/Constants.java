...
public class Constants {
    public final static  String SALT = "fdsajflkj?.&8)[][fdsfdljkl"; //md5加密盐值

    public final static String FILE_UPLOAD_DIC = "/Users/yelei/upload/";//上传文件的默认url前缀，根据部署设置自行修改
    ...
    public final static int SHOPPING_CART_ITEM_TOTAL_NUMBER = 20;//购物车中商品种类的最大数量
    ...
    public final static String USER_INTRO = "随新所欲，丰富多彩";//默认简介
}
